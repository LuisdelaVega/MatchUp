...
myApp.controller('sidebarController', ['$scope', '$window', '$http', '$state', 'AuthenticationService', '$rootScope', 'MatchUpCache', function ($scope, $window, $http, $state, AuthenticationService, $rootScope, MatchUpCache) {
