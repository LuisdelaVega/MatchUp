...
(
    ...
    CONSTRAINT "PK_report" PRIMARY KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number, set_seq, report_number),
    CONSTRAINT "FK_report_set" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number, set_seq) REFERENCES "set" (event_name, event_start_date, event_location, tournament_name, round_number, match_number, set_seq)
)
WITH (
  OIDS=FALSE
);
...
(
    ...
    CONSTRAINT "PK_group" PRIMARY KEY (event_name, event_start_date, event_location, tournament_name, competitor_number, group_number),
    CONSTRAINT "FK_group_competitor" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, competitor_number)
    REFERENCES competitor (event_name, event_start_date, event_location, tournament_name, competitor_number) MATCH SIMPLE
    ON UPDATE NO ACTION ON DELETE NO ACTION
)
WITH (
