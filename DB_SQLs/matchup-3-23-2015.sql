...
COPY competes (event_name, event_start_date, event_location, tournament_name, round_number, match_number, competitor_number, set_completed) FROM stdin;
\.
...
COPY competitor (event_name, event_start_date, event_location, tournament_name, competitor_number, competitor_standing, competitor_seed, matches_won, matches_lost, competitor_has_forfeited) FROM stdin;
\.
...
COPY competitor_goes_to (event_name, event_start_date, event_location, tournament_name, round_number, past_match, future_match, is_winner) FROM stdin;
\.
...
COPY pays (event_name, event_start_date, event_location, spec_fee_name, customer_username) FROM stdin;
\.
...
COPY round (event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, round_start_date, round_pause, round_completed, round_type) FROM stdin;
\.
...
ALTER TABLE ONLY competitor_goes_to
    ADD CONSTRAINT "PK_competitor_goes_to" PRIMARY KEY (event_name, event_start_date, event_location, tournament_name, round_number, past_match, future_match, is_winner);
...
ALTER TABLE ONLY competitor_goes_to
    ADD CONSTRAINT "FK_competitor_goes_to_future_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, future_match) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, match_number);
...
ALTER TABLE ONLY competitor_goes_to
    ADD CONSTRAINT "FK_competitor_goes_to_past_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, past_match) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, match_number);
