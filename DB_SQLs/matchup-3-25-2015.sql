...
COPY competes (event_name, event_start_date, event_location, tournament_name, round_number, match_number, competitor_number) FROM stdin;
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	1	1	4
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	1	1	5
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	2	1	1
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	2	2	2
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	2	2	3
\.
...
COPY competitor_goes_to (event_name, event_start_date, event_location, tournament_name, past_round_number, past_match, future_round_number, future_match, is_winner) FROM stdin;
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	1	1	2	1	t
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	2	1	3	1	t
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	2	2	3	1	t
\.
...
COPY group_stage (event_name, event_start_date, event_location, tournament_name, round_number, match_number, competitor_number, group_number, group_placing) FROM stdin;
\.
...
COPY is_played_in (event_name, event_start_date, event_location, tournament_name, round_number, match_number, station_number) FROM stdin;
\.
...
COPY match (event_name, event_start_date, event_location, tournament_name, round_number, match_number, is_favourite, match_completed) FROM stdin;
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	1	1	f	f
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	2	1	f	f
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	2	2	f	f
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	3	1	f	f
\.
...
COPY report (event_name, event_start_date, event_location, tournament_name, round_number, match_number, set_seq, report_number, report_description, report_image, report_date, report_type) FROM stdin;
\.
...
COPY set (event_name, event_start_date, event_location, tournament_name, round_number, match_number, set_seq, set_completed) FROM stdin;
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	1	1	1	f
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	2	1	1	f
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	2	2	1	f
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	3	1	1	f
\.
...
COPY submits (event_name, event_start_date, event_location, tournament_name, round_number, match_number, set_seq, competitor_number, score) FROM stdin;
\.
...
First Test	2015-10-19 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Super Smash Bros. Melee Qualifiers	Super Smash Bros. Melee	Rules of the rules with rules comprised of rules	f	2015-10-19 11:00:00	2015-10-19 10:00:00	10.00	32	100.00	Single Stage	Double Elimination	Match	6	2
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Super Smash Bros. Melee Qualifiers	Super Smash Bros. Melee	Rules of the rules with rules comprised of rules	f	2015-06-05 11:00:00	2015-06-05 10:00:00	10.00	32	100.00	Two-Stage	Double Elimination	Match	4	2
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Ultra Street Fighter IV Qualifiers	Ultra Street Fighter IV	Rules of the rules with rules comprised of rules	f	2015-03-25 11:00:00	2015-03-25 10:00:00	10.00	32	100.00	Single Stage	Single Elimination	Match	0	0
Event 01	2015-03-25 09:00:00	University of Puerto Rico at Mayagüez, Mayaguez, PR 00681-9042	Mortal Kombat X Qualifiers	Mortal Kombat X	Rules of the rules with rules comprised of rules	f	2015-03-25 11:00:00	2015-03-25 10:00:00	10.00	32	100.00	Single Stage	Double Elimination	Match	0	0
\.
...
ALTER TABLE ONLY competes
    ADD CONSTRAINT "PK_competes" PRIMARY KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number, competitor_number);
...
ALTER TABLE ONLY competitor_goes_to
    ADD CONSTRAINT "PK_competitor_goes_to" PRIMARY KEY (event_name, event_start_date, event_location, tournament_name, past_round_number, past_match, future_round_number, future_match, is_winner);
...
ALTER TABLE ONLY is_played_in
    ADD CONSTRAINT "PK_is_played_in" PRIMARY KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number, station_number);
...
ALTER TABLE ONLY match
    ADD CONSTRAINT "PK_match" PRIMARY KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number);
...
ALTER TABLE ONLY report
    ADD CONSTRAINT "PK_report" PRIMARY KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number, set_seq, report_number);
...
ALTER TABLE ONLY round
    ADD CONSTRAINT "PK_round" PRIMARY KEY (event_name, event_start_date, event_location, tournament_name, round_number);
...
ALTER TABLE ONLY set
    ADD CONSTRAINT "PK_set" PRIMARY KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number, set_seq);
...
ALTER TABLE ONLY submits
    ADD CONSTRAINT "PK_submits" PRIMARY KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number, set_seq);
...
ALTER TABLE ONLY competes
    ADD CONSTRAINT "FK_competes_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, match_number);
...
ALTER TABLE ONLY competitor_goes_to
    ADD CONSTRAINT "FK_competitor_goes_to_future_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, future_round_number, future_match) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, match_number);
...
ALTER TABLE ONLY competitor_goes_to
    ADD CONSTRAINT "FK_competitor_goes_to_past_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, past_round_number, past_match) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, match_number);
...
ALTER TABLE ONLY group_stage
    ADD CONSTRAINT "FK_group_stage_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, match_number);
...
ALTER TABLE ONLY is_played_in
    ADD CONSTRAINT "FK_is_played_in_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, match_number);
...
ALTER TABLE ONLY match
    ADD CONSTRAINT "FK_match_round" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number) REFERENCES round(event_name, event_start_date, event_location, tournament_name, round_number);
...
ALTER TABLE ONLY report
    ADD CONSTRAINT "FK_report_set" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number, set_seq) REFERENCES set(event_name, event_start_date, event_location, tournament_name, round_number, match_number, set_seq);
...
ALTER TABLE ONLY set
    ADD CONSTRAINT "FK_set_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, match_number);
...
ALTER TABLE ONLY submits
    ADD CONSTRAINT "FK_submits_set" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, match_number, set_seq) REFERENCES set(event_name, event_start_date, event_location, tournament_name, round_number, match_number, set_seq);
