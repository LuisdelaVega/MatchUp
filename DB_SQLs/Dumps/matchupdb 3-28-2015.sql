...
--
-- Name: FK_belongs_to_customerON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY belongs_to
    ADD CONSTRAINT "FK_belongs_to_customer" FOREIGN KEY (customer_username) REFERENCES customer(customer_username)ON UPDATE CASCADE;


--
-- Name: FK_belongs_to_organizationON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY belongs_to
    ADD CONSTRAINT "FK_belongs_to_organization" FOREIGN KEY (organization_name) REFERENCES organization(organization_name)ON UPDATE CASCADE;


--
-- Name: FK_capacity_for_stationON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY capacity_for
    ADD CONSTRAINT "FK_capacity_for_station" FOREIGN KEY (event_name, event_start_date, event_location, station_number) REFERENCES station(event_name, event_start_date, event_location, station_number)ON UPDATE CASCADE;


--
-- Name: FK_capacity_for_tournamentON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY capacity_for
    ADD CONSTRAINT "FK_capacity_for_tournament" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name) REFERENCES tournament(event_name, event_start_date, event_location, tournament_name)ON UPDATE CASCADE;


--
-- Name: FK_captain_for_customerON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY captain_for
    ADD CONSTRAINT "FK_captain_for_customer" FOREIGN KEY (customer_username) REFERENCES customer(customer_username)ON UPDATE CASCADE;


--
-- Name: FK_captain_for_teamON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY captain_for
    ADD CONSTRAINT "FK_captain_for_team" FOREIGN KEY (team_name) REFERENCES team(team_name)ON UPDATE CASCADE;


--
-- Name: FK_competes_competitorON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY competes
    ADD CONSTRAINT "FK_competes_competitor" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, competitor_number) REFERENCES competitor(event_name, event_start_date, event_location, tournament_name, competitor_number)ON UPDATE CASCADE;


--
-- Name: FK_competes_for_competitorON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY competes_for
    ADD CONSTRAINT "FK_competes_for_competitor" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, competitor_number) REFERENCES competitor(event_name, event_start_date, event_location, tournament_name, competitor_number)ON UPDATE CASCADE;


--
-- Name: FK_competes_for_teamON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY competes_for
    ADD CONSTRAINT "FK_competes_for_team" FOREIGN KEY (team_name) REFERENCES team(team_name)ON UPDATE CASCADE;


--
-- Name: FK_competes_matchON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY competes
    ADD CONSTRAINT "FK_competes_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number)ON UPDATE CASCADE;


--
-- Name: FK_competitor_goes_to_future_matchON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY competitor_goes_to
    ADD CONSTRAINT "FK_competitor_goes_to_future_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, future_round_number, future_round_is_winner, future_match) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number)ON UPDATE CASCADE;


--
-- Name: FK_competitor_goes_to_past_matchON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY competitor_goes_to
    ADD CONSTRAINT "FK_competitor_goes_to_past_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, past_round_number, past_round_is_winner, past_match) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number)ON UPDATE CASCADE;


--
-- Name: FK_competitor_tournamentON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY competitor
    ADD CONSTRAINT "FK_competitor_tournament" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name) REFERENCES tournament(event_name, event_start_date, event_location, tournament_name)ON UPDATE CASCADE;


--
-- Name: FK_event_customerON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY event
    ADD CONSTRAINT "FK_event_customer" FOREIGN KEY (customer_username) REFERENCES customer(customer_username)ON UPDATE CASCADE;


--
-- Name: FK_group_competitorON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY "group"
    ADD CONSTRAINT "FK_group_competitor" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, competitor_number) REFERENCES competitor(event_name, event_start_date, event_location, tournament_name, competitor_number)ON UPDATE CASCADE;


--
-- Name: FK_group_stage_groupON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY group_stage
    ADD CONSTRAINT "FK_group_stage_group" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, competitor_number, group_number) REFERENCES "group"(event_name, event_start_date, event_location, tournament_name, competitor_number, group_number)ON UPDATE CASCADE;


--
-- Name: FK_group_stage_matchON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY group_stage
    ADD CONSTRAINT "FK_group_stage_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number)ON UPDATE CASCADE;


--
-- Name: FK_hosts_eventON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY hosts
    ADD CONSTRAINT "FK_hosts_event" FOREIGN KEY (event_name, event_start_date, event_location) REFERENCES event(event_name, event_start_date, event_location)ON UPDATE CASCADE;


--
-- Name: FK_hosts_organizationON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY hosts
    ADD CONSTRAINT "FK_hosts_organization" FOREIGN KEY (organization_name) REFERENCES organization(organization_name)ON UPDATE CASCADE;


--
-- Name: FK_is_a_competitorON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY is_a
    ADD CONSTRAINT "FK_is_a_competitor" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, competitor_number) REFERENCES competitor(event_name, event_start_date, event_location, tournament_name, competitor_number)ON UPDATE CASCADE;


--
-- Name: FK_is_a_customerON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY is_a
    ADD CONSTRAINT "FK_is_a_customer" FOREIGN KEY (customer_username) REFERENCES customer(customer_username)ON UPDATE CASCADE;


--
-- Name: FK_is_of_gameON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY is_of
    ADD CONSTRAINT "FK_is_of_game" FOREIGN KEY (game_name) REFERENCES game(game_name)ON UPDATE CASCADE;


--
-- Name: FK_is_of_genreON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY is_of
    ADD CONSTRAINT "FK_is_of_genre" FOREIGN KEY (genre_name) REFERENCES genre(genre_name)ON UPDATE CASCADE;


--
-- Name: FK_is_played_in_matchON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY is_played_in
    ADD CONSTRAINT "FK_is_played_in_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number)ON UPDATE CASCADE;


--
-- Name: FK_is_played_in_stationON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY is_played_in
    ADD CONSTRAINT "FK_is_played_in_station" FOREIGN KEY (event_name, event_start_date, event_location, station_number) REFERENCES station(event_name, event_start_date, event_location, station_number)ON UPDATE CASCADE;


--
-- Name: FK_match_roundON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY match
    ADD CONSTRAINT "FK_match_round" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner) REFERENCES round(event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner)ON UPDATE CASCADE;


--
-- Name: FK_meetup_customerON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY meetup
    ADD CONSTRAINT "FK_meetup_customer" FOREIGN KEY (customer_username) REFERENCES customer(customer_username)ON UPDATE CASCADE;


--
-- Name: FK_meetup_eventON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY meetup
    ADD CONSTRAINT "FK_meetup_event" FOREIGN KEY (event_name, event_start_date, event_location) REFERENCES event(event_name, event_start_date, event_location)ON UPDATE CASCADE;


--
-- Name: FK_news_eventON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY news
    ADD CONSTRAINT "FK_news_event" FOREIGN KEY (event_name, event_start_date, event_location) REFERENCES event(event_name, event_start_date, event_location)ON UPDATE CASCADE;


--
-- Name: FK_of_email_customerON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY of_email
    ADD CONSTRAINT "FK_of_email_customer" FOREIGN KEY (customer_username) REFERENCES customer(customer_username)ON UPDATE CASCADE;


--
-- Name: FK_owns_customerON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY owns
    ADD CONSTRAINT "FK_owns_customer" FOREIGN KEY (customer_username) REFERENCES customer(customer_username)ON UPDATE CASCADE;


--
-- Name: FK_owns_organizationON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY owns
    ADD CONSTRAINT "FK_owns_organization" FOREIGN KEY (organization_name) REFERENCES organization(organization_name)ON UPDATE CASCADE;


--
-- Name: FK_pays_customerON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY pays
    ADD CONSTRAINT "FK_pays_customer" FOREIGN KEY (customer_username) REFERENCES customer(customer_username)ON UPDATE CASCADE;


--
-- Name: FK_pays_spectator_feeON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY pays
    ADD CONSTRAINT "FK_pays_spectator_fee" FOREIGN KEY (event_name, event_start_date, event_location, spec_fee_name) REFERENCES spectator_fee(event_name, event_start_date, event_location, spec_fee_name)ON UPDATE CASCADE;


--
-- Name: FK_plays_for_customerON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY plays_for
    ADD CONSTRAINT "FK_plays_for_customer" FOREIGN KEY (customer_username) REFERENCES customer(customer_username)ON UPDATE CASCADE;


--
-- Name: FK_plays_for_team_nameON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY plays_for
    ADD CONSTRAINT "FK_plays_for_team_name" FOREIGN KEY (team_name) REFERENCES team(team_name)ON UPDATE CASCADE;


--
-- Name: FK_report_setON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY report
    ADD CONSTRAINT "FK_report_set" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number, set_seq) REFERENCES set(event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number, set_seq)ON UPDATE CASCADE;


--
-- Name: FK_request_customerON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY request
    ADD CONSTRAINT "FK_request_customer" FOREIGN KEY (customer_username) REFERENCES customer(customer_username)ON UPDATE CASCADE;


--
-- Name: FK_review_customerON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY review
    ADD CONSTRAINT "FK_review_customer" FOREIGN KEY (customer_username) REFERENCES customer(customer_username)ON UPDATE CASCADE;


--
-- Name: FK_review_eventON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY review
    ADD CONSTRAINT "FK_review_event" FOREIGN KEY (event_name, event_start_date, event_location) REFERENCES event(event_name, event_start_date, event_location)ON UPDATE CASCADE;


--
-- Name: FK_round_tournamentON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY round
    ADD CONSTRAINT "FK_round_tournament" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name) REFERENCES tournament(event_name, event_start_date, event_location, tournament_name)ON UPDATE CASCADE;


--
-- Name: FK_set_matchON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY set
    ADD CONSTRAINT "FK_set_match" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number) REFERENCES match(event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number)ON UPDATE CASCADE;


--
-- Name: FK_shows_eventON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY shows
    ADD CONSTRAINT "FK_shows_event" FOREIGN KEY (event_name, event_start_date, event_location) REFERENCES event(event_name, event_start_date, event_location)ON UPDATE CASCADE;


--
-- Name: FK_shows_sponsorON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY shows
    ADD CONSTRAINT "FK_shows_sponsor" FOREIGN KEY (sponsor_name) REFERENCES sponsors(sponsor_name)ON UPDATE CASCADE;


--
-- Name: FK_spectator_fee_eventON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY spectator_fee
    ADD CONSTRAINT "FK_spectator_fee_event" FOREIGN KEY (event_name, event_start_date, event_location) REFERENCES event(event_name, event_start_date, event_location)ON UPDATE CASCADE;


--
-- Name: FK_station_eventON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY station
    ADD CONSTRAINT "FK_station_event" FOREIGN KEY (event_name, event_start_date, event_location) REFERENCES event(event_name, event_start_date, event_location)ON UPDATE CASCADE;


--
-- Name: FK_stream_stationON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY stream
    ADD CONSTRAINT "FK_stream_station" FOREIGN KEY (event_name, event_start_date, event_location, station_number) REFERENCES station(event_name, event_start_date, event_location, station_number)ON UPDATE CASCADE;


--
-- Name: FK_submits_competitorON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY submits
    ADD CONSTRAINT "FK_submits_competitor" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, competitor_number) REFERENCES competitor(event_name, event_start_date, event_location, tournament_name, competitor_number)ON UPDATE CASCADE;


--
-- Name: FK_submits_setON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY submits
    ADD CONSTRAINT "FK_submits_set" FOREIGN KEY (event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number, set_seq) REFERENCES set(event_name, event_start_date, event_location, tournament_name, round_number, round_is_winner, match_number, set_seq)ON UPDATE CASCADE;


--
-- Name: FK_subscribed_to_customer_interestON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY subscribed_to
    ADD CONSTRAINT "FK_subscribed_to_customer_interest" FOREIGN KEY (interest) REFERENCES customer(customer_username)ON UPDATE CASCADE;


--
-- Name: FK_subscribed_to_customer_subscriberON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY subscribed_to
    ADD CONSTRAINT "FK_subscribed_to_customer_subscriber" FOREIGN KEY (subscriber) REFERENCES customer(customer_username)ON UPDATE CASCADE;


--
-- Name: FK_to_play_gameON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY to_play
    ADD CONSTRAINT "FK_to_play_game" FOREIGN KEY (game_name) REFERENCES game(game_name)ON UPDATE CASCADE;


--
-- Name: FK_to_play_meetupON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY to_play
    ADD CONSTRAINT "FK_to_play_meetup" FOREIGN KEY (event_name, event_start_date, event_location, meetup_location, meetup_start_date) REFERENCES meetup(event_name, event_start_date, event_location, meetup_location, meetup_start_date)ON UPDATE CASCADE;


--
-- Name: FK_tournament_eventON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY tournament
    ADD CONSTRAINT "FK_tournament_event" FOREIGN KEY (event_name, event_start_date, event_location) REFERENCES event(event_name, event_start_date, event_location)ON UPDATE CASCADE;


--
-- Name: FK_tournament_gameON UPDATE CASCADE; Type: FK CONSTRAINTON UPDATE CASCADE; Schema: publicON UPDATE CASCADE; Owner: edwinbadillo
--

ALTER TABLE ONLY tournament
    ADD CONSTRAINT "FK_tournament_game" FOREIGN KEY (game_name) REFERENCES game(game_name)ON UPDATE CASCADE;
